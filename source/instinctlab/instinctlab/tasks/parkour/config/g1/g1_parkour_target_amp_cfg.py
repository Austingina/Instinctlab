...
class AmassMotionCfg(AmassMotionCfgBase):
    ...
    filtered_motion_selection_filepath = os.path.expanduser("/home/ubuntu/instinctlab/hiking-in-the-wild_Data&Model/data&model/parkour_motion_reference/parkour_motion_without_run.yaml")
